...
# Desafio 2: Verificar se um número pertence a sequenncia 
print("Desafio 2: Verificar se um número pertence a sequencia de Fibonacci")
...
mensagem = (
    ...
    else "NÃO pertence a sequencia de Fibonacci."
)
...
print("\nDesafio 3: Analise de faturamento mensal")
...
# Calcula o percentual cada estado
percentuais = {}
